...
Dataframe union() – union() method of the DataFrame is used to merge two DataFrames of the same structure/schema. If schemas are not the same it returns an error.
